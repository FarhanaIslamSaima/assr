...
bg-gray-900 border-gray-700 h-[450px] card-border-effect"
      >
        <div className="px-4 pt-4">
          <div className="flex flex-col items-center pb-10">
            <img
              ...
              alt="Bonnie image"
            />
            <h5 className="mb-5 text-xl font-medium text-white hover:animate-wiggle">
              {item.name}
            </h5>
            <span className="text-sm text-gray-400">{item.post}</span>
            <span className="text-sm text-gray-400">Undergraduate Student</span>
            ...
            <div className="w-[80%] justify-between flex mt-4 md:mt-6">
              ...
              <div className="socialAnimation hover:animate-spin-slow">
                <Link
                  href={item.linkedin? item.linkedin:"#"} target="blank"
                  className="inline-flex items-center px-2 
                          py-2 md:text-2xl	font-medium text-center text-xl
                          socialButton 
                           "
              ...
              <div className="socialAnimation hover:animate-spin-slow">
                <Link
                  href={item.facebook? item.facebook:"#"} target="blank"
                  className="inline-flex items-center px-2 
                          py-2 md:text-2xl	font-medium text-center text-xl
                          socialButton
                           "
              ...
              <div className="socialAnimation hover:animate-spin-slow">
                <Link
                  href={item.portfolio? item.portfolio:"#"} target="blank"
                  className="inline-flex items-center px-2 
                          py-2 md:text-2xl	font-medium text-center text-xl
                          socialButton
                           "
